...
NOTE: Todos os estudantes devem informar no campo de `usuário` o número de sua matrícula e no campo de `senha` a senha padrão @IFTO+DATA DE NASCIMENTO (Ex.: @IFTO01012001). Após efetuar o primeiro acesso, orientamos alterar sua senha para uma de uso pessoal.
...
NOTE: atendimento para questões dúvidas/técnicas: coava.cread@ifto.edu.br
